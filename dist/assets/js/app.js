...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#form').validate({
  ...
  errorPlacement: function errorPlacement(error, element) {
    var placement = jquery__WEBPACK_IMPORTED_MODULE_0___default()(element).data('error');

    if (placement) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(placement).append(error);
    } else {
...
module.exports = __webpack_require__(/*! C:\Users\Alexander\Desktop\Projects\markup\src\assets\js\app.js */"./src/assets/js/app.js");
